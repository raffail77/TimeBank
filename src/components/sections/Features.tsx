...
const features = [
  {
    ...
    description: "Our intelligent recommendation system analyzes your profile and transaction history to suggest perfect service matches.",
  ...
  },
  {
    ...
    description: "Fair and transparent: 30 minutes of service = 1 time credit. Simple economics that benefit everyone equally.",
    gradient: "from-gold to-gold-light",
  },
  {
    icon: Users,
