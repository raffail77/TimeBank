...
const ServiceDetail = () => {
  ...
  const contactLabel = service.service_type === "offer" ? "Get Service" : "Offer Service";
      ...
      <main className="pt-24 pb-16">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              {/* Pricing / Order Panel */}
              <div className="rounded-xl border border-border bg-card p-6 space-y-5 lg:static lg:top-28">
                <div>
